...
cols = ['Date', 'Page Type', 'Account Type', 'Author', 'Full Text', 'Gender', 'Hashtags', 'Impact', 'Impressions', 'Thread Entry Type', 'Twitter Followers', 'Twitter Following', 'Twitter Tweets', 'Twitter Verified', 'Reach (new)', 'Region']
